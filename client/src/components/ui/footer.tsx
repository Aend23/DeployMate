    ...
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <h3 className="text-lg font-bold text-white mb-4">About DeployMate</h3>
            <p className="text-sm">
              DeployMate simplifies deployment for developers, providing seamless GitHub integration, real-time monitoring, and visitor analytics. Empower your apps to go live effortlessly!
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} DeployMate. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
