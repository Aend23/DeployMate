    ...
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        ...
        <AccordionContent className=" text-left text-xl font-thin">
          DeployMate is a platform that lets you deploy your React applications
      ...
      <AccordionItem value="item-3" className=" text-xl font-normal">
        ...
        <AccordionContent className=" text-left text-xl font-thin">
          Yes! DeployMate provides visitor trends and geolocation data, giving
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent className=" text-left text-xl font-thin">
          DeployMate integrates with AWS SQS, ECS, Lambda, S3, and CloudFront
